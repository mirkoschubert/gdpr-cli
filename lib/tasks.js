...
class Tasks {
  constructor(url, uiInstance) {
    ...
    //this.getMandatoryTasks().forEach(task => this.new(task));
  ...
  getSocialMediaInformation() {
    ...
    if (this.hasTask('social')) {
      ...
      console.log('FB CONNECT:', social.hasFacebookConnect(this.data.js));
      console.log('FB SOCIAL GRAPH:', social.hasFacebookSocialGraph(this.data.js));
      console.log('PINTEREST:', social.hasPinterest(this.data.js));
